...
require_relative 'lib/homebus-image-publisher/version'

Gem::Specification.new do |spec|
  spec.name = 'homebus-image-publisher'
  spec.version = HomebusImagePublisher::VERSION
  ...
  spec.homepage = 'https://github.com/HomeBusProjects/homebus-image-publisher'
  spec.license = 'MIT'
  spec.required_ruby_version = ">= #{File.read('.ruby-version')}"

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/HomeBusProjects/homebus-image-publisher'
